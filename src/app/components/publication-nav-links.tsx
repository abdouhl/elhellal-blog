...
function PublicationNavLinks(props: Props) {
  ...
  const navItemsRef = useRef(
    [
      { label: 'الرئيسية', url: '/', isActive: !currentActiveMenuItemId && isHome },
  ...
  console.log(activeDropdownMenuItem?.label)
              ...
              >
                ...
                >
                  <span className="capitalize">
                    {isActiveItemInDropdown ? `${activeDropdownMenuItem?.label}` : 'المزيد'}
                  </span>
